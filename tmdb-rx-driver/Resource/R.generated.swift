...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let actorDetailViewController = StoryboardViewControllerResource<ActorDetailViewController>(identifier: "ActorDetailViewController")
      let bundle = R.hostingBundle
      ...
      func actorDetailViewController(_: Void = ()) -> ActorDetailViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: actorDetailViewController)
      }
      ...
      static func validate() throws {
        ...
        if _R.storyboard.main().actorDetailViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'actorDetailViewController' could not be loaded from storyboard 'Main' as 'ActorDetailViewController'.") }
